...
modelfile = r"C:\Users\Naveen\OneDrive\Desktop\wholesale_customer_segmentation_ML\models\final_prediction.pickle"
model = pickle.load(open(modelfile, 'rb')) 

# Remove duplicate import of Flask and request
app = Flask(__name__) 
